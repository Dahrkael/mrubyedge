...
fn main() {
    ...
    let irep1 = vm::IREP {
        ...
        code: vec![
            op::Op {
                code: OpCode::ENTER,
                operand: Fetched::W(0x40000),
                pos: 0,
                len: 4,
            },
            op::Op {
                code: OpCode::MOVE,
                operand: Fetched::BB(3, 1),
                pos: 4,
                len: 3,
            },
            op::Op {
    ...
    let irep0 = vm::IREP {
        ...
        code: vec![
            ...
            op::Op {
                code: OpCode::METHOD,
                operand: Fetched::BB(2, 0),
                pos: 2,
                len: 3,
            },
            op::Op {
                code: OpCode::DEF,
                operand: Fetched::BB(1, 0),
                pos: 5,
                len: 3,
            },
            op::Op {
                code: OpCode::LOADI,
                operand: Fetched::BB(2, 25),
                pos: 8,
                len: 3,
            },
            op::Op {
                code: OpCode::SSEND,
                operand: Fetched::BBB(1, 0, 1),
                pos: 11,
                len: 4,
            },
            op::Op {
